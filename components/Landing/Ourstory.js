  ...
  return (
    ...
    <div className="mx-5 mt-10 ">
      <div className="flex flex-row justify-between items-center ">
        <h3 className="font-normal text-xl text-[#CB6146] ">OUR STORY</h3>
      ...
      <div className="">
        <p className="font-light text-[14px] leading-[30.8px] text-[#404040] ">
      ...
      <button className="font-normal text-base text-[#A8472F] flex flex-row items-end  my-6 ">
        Full Story
        <span className="pl-3">
      ...
      <div className="flex flex-row justify-center items-end mt-10">
        ...
        <div className="flex flex-row justify-between items-center">
          <h3 className="font-normal text-[18px] leading-[28.8px] text-[#CB6146] pr-7">ON SOCIAL</h3>
      ...
      <div className="flex flex-row justify-between items-center relative mt-6 mb-10">
        <h3 className="font-normal text-xl text-[#CB6146] ">FOLLOW US ON INSTAGRAM</h3>
        <span className="w-20 h-[2px] bg-[#cb6146] mr-5"></span>
        <img src="/arrow-right.svg" className="absolute right-2 top-[4.15px]"/>
      </div>
    </div>
    </>
  )
